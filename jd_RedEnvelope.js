...
ck1助力 作者
其余助力ck1
https://u.jd.com/3MUI07z
跳转到app 可查看助力情况
1 6,12,18 * * * jd_RedEnvelope.js
添加环境变量jd_redEnvelope_rebateCode 如需自己吃返利，请填写该变量（https://u.jd.com/后面的英文）
*/
...
function getUA(){
    ...
    rebateCode = '3MUI07z'
    if($.index != 1){
        let arr = [rebateCodes,'3MUI07z']
        rebateCode = arr[Math.floor(Math.random() * arr.length)] || rebateCode
        if(!rebateCode) rebateCode = '3MUI07z'
    }
