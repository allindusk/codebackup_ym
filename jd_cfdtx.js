...
$.cookieArr = [];
$.currentCookie = '';
$.tokenArr = [{"farm_jstoken":"9a26c3d5fdd1668d91900f473141c32c","timestamp":"1610441576034","phoneid":"bdc03a4fc9be38b2-35355204688244"},{"farm_jstoken":"213281b5107d42a0bff00fd4e90f8551","timestamp":"1621195703356","phoneid":"bdc03a4fc9be38b2"}];
...
!(async () => {
  ...
  for (let i = 0; i < $.cookieArr.length; i++) {
    ...
    const currentToken = $.tokenArr[i]//$.tokenArr.find((item) => {
