...
[task_local]
#内容鉴赏官
15 6,20 * * * https://raw.githubusercontent.com/yongyuanlin/jd_scripts/master/jd_connoisseur.js, tag=内容鉴赏官, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true

================Loon==============
[Script]
cron "15 6,20 * * *" script-path=https://raw.githubusercontent.com/yongyuanlin/jd_scripts/master/jd_connoisseur.js,tag=内容鉴赏官

===============Surge=================
内容鉴赏官 = type=cron,cronexp="15 6,20 * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/yongyuanlin/jd_scripts/master/jd_connoisseur.js

============小火箭=========
内容鉴赏官 = type=cron,script-path=https://raw.githubusercontent.com/yongyuanlin/jd_scripts/master/jd_connoisseur.js, cronexpr="15 6,20 * * *", timeout=3600, enable=true
 */
const $ = new Env('内容鉴赏官');
